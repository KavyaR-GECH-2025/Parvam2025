...
public class StartStudent {
	...
	public static void main(String[] args) {
		...
		//Student std4 =new Student("Anitha", 404, 23);
		List<Student> students = new ArrayList<>();
		students.add(std1);
		students.add(std2);
		students.add(std3);
		//students.add(std4);
		students.add(new Student("Sunitha",400,20));
		...
		Collections.sort(students,(s1,s2)->s2.getRoll_no()-s1.getRoll_no());//for descending sorting
		System.out.println(students);
		System.out.println();
		
		System.out.println("Ascending sorting");
		Collections.sort(students,(s1,s2)->s1.getRoll_no()-s2.getRoll_no());//for ascending sorting
		System.out.println(students);
		System.out.println();
